...
<?php
    ...
    $getExistingAccessSQL = "SELECT cms_accessrequest.PageID, CustomTitle, cms_users.FirstName, cms_users.LastName, Pending, cms_accessrequest.ID "
    ...
    foreach($content as $page)
    {
          ...
          echo '<td><a id="remove' . $page["ID"] . '" class="btn btn-default" href="javascript:;" onclick="removeAccess(' . $page["ID"] . ')" role="button">Revoke</a></td>'; 
          echo '</tr>';
    }
    echo '</tbody></table>';

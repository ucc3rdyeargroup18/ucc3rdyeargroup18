...
if(isset($_POST['submission']) && $_POST['submission'] === "true"){ // the form has been submitted, process it
    ...
    if(count($errors) > 0){
        ...
        $insertSQL = "INSERT INTO cms_pets (CharityID, CreatorID, CreatedOn, EditorID, EditedOn, Name, Description, Contact, Number1, Email, Location, isAdoptable)"
                ...
                . "{$_SESSION['userID']}, NOW(), {$_SESSION['userID']}, NOW(), '{$petDetails['Name']}', '{$petDetails['Description']}', '{$petDetails['ContactName']}', '{$petDetails['Number']}', '{$petDetails['Email']}', '{$petDetails['Location']}', 1);";
...
<!-- Begin page content -->
      <div class="container">
        <div class="page-header">
          <h1>Submit Adoptable Animal</h1>
        </div>
          <div class="col-md-9">
        <p class="lead">Your adoptable animal has been added to our database.</p>
        <hr />

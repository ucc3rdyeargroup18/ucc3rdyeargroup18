...
?>
      ...
      <div class="container">
        <div class="page-header">
          ...
          <div class="col-md-9">
        <p class="lead">Here are some animals we rescued that are too sick or old to leave us</p>
        <p>If you are interested in helping these ones, click the donate button on the details page</p>
        <hr />

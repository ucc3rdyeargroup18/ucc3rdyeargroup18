...
?>
      ...
      <!--div class="row"-->
        ...
        $getLostPetsSQL = "SELECT Name, Details, Image1, LostFoundID, LastSeen FROM CMS_LostFounds WHERE CharityID = {$info['CharityID']} AND isLost = 0 ORDER BY CreatedOn DESC";
